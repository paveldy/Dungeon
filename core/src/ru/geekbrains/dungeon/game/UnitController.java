...
public class UnitController {
    ...
    public boolean isItMyTurn(Unit unit) {
        //++++++++++++++++++++++++++++++
        if (unit == hero && gc.getUnitController().hero.turns == 5) {
            gc.getUnitController().hero.countCalc();
        }
...
//                gc.getUnitController().hero.money();
                return false;
            }
        }
        return true;
...
//+++++++++++++++++++++++++++++++++++
    public void initNewMonster() {
        ...
        monsterController.activate((int) (Math.random() * gc.getGameMap().CELLS_X),
                (int) (Math.random() * gc.getGameMap().CELLS_Y));
    }
//+++++++++++++++++++++++++++++++++++
